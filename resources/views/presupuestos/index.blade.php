                        ...
                        <tbody class="text-sm text-gray-700">
                            @forelse($presupuestos as $presupuesto)
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="py-2 px-4 border">{{ $presupuesto->responsable ?? 'Sin asignar' }}</td>

                                    {{-- Acciones solo para anciano --}}
                                    @if ($rolUsuario === 'anciano')
                            ...
                            @empty
                                <tr>
                                    <td colspan="{{ $rolUsuario === 'anciano' ? '9' : '8' }}" class="text-center py-4 text-gray-500">
