...
@section('content')
    <div class="flex flex-col min-h-screen bg-gray-50 items-center w-full max-w-7xl mx-auto px-4 py-4">
        <!-- Contenedor más ancho y centrado -->
        <!-- Encabezado -->
        <div class="text-center mb-8">
            <img src="{{ asset('images/logo-actu.png') }}" alt="Logo ACTU" class="mx-auto"
                style="width: 140px; height: 120px; margin-top: 0;">
