                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="numero_identificacion"
                            value="{{ old('numero_identificacion', $miembro->numero_identificacion) }}"
                            class="w-full border rounded p-2" required>
                    </div>

                    <div>
                        <label>Email</label>
                        <input type="email" name="email" value="{{ old('email', $miembro->email) }}"
                    ...
                    <div class="col-span-2">
                        ...
                        <select name="estado" class="w-full border rounded p-2">
                            ...
                            <option value="con excusa" {{ $miembro->estado == 'con excusa' ? 'selected' : '' }}>Con
                                excusa/permanente</option>
                            <option value="ausente" {{ $miembro->estado == 'ausente' ? 'selected' : '' }}>Ausente</option>
                            <option value="fallecido" {{ $miembro->estado == 'fallecido' ? 'selected' : '' }}>Fallecido
                            </option>
                            <option value="trasladado" {{ $miembro->estado == 'trasladado' ? 'selected' : '' }}>Trasladado
                            </option>
                            <option value="no bautizado" {{ $miembro->estado == 'no bautizado' ? 'selected' : '' }}>No
                                Bautizado
                            </option>
                            <option value="disciplina" {{ $miembro->estado == 'disciplina' ? 'selected' : '' }}>Disciplina
                            </option>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button id="confirmarModal"
                        class="bg-[#0166b3] hover:bg-[#014a82] text-white font-bold py-2 px-4 rounded">
                        Sí, actualizar
                    </button>
                </div>
            </div>
